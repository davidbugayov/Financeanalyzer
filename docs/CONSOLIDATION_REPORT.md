...
## Статистика
- Всего дублирующихся значений: 57
- Файлов strings.xml: 16
...
### 'Добавить транзакцию'
- ui/src/main/res/values/strings.xml: action_add_transaction
...
### 'Развлечения'
- ui/src/main/res/values/strings.xml: category_entertainment
- ui/src/main/res/values/strings.xml: subcategory_demo_entertainment

### 'Продукты'
- ui/src/main/res/values/strings.xml: category_food
- ui/src/main/res/values/strings.xml: subcategory_demo_food
...
### 'Рестораны'
- ui/src/main/res/values/strings.xml: category_restaurant
- ui/src/main/res/values/strings.xml: subcategory_demo_restaurant
...
### 'Транспорт'
- ui/src/main/res/values/strings.xml: category_transport
- ui/src/main/res/values/strings.xml: subcategory_demo_transport
...
- ui/src/main/res/values/strings.xml: tip_create_emergency_fund_title
...
- ui/src/main/res/values/strings.xml: income_category
...
- ui/src/main/res/values/strings.xml: increase_savings_rate_title_ui
- ui/src/main/res/values/strings.xml: tip_increase_savings_title
...
### 'Темная'
- ui/src/main/res/values/strings.xml: profile_theme_dark
...
### 'Эксперт категорий'
- ui/src/main/res/values/strings.xml: achievement_category_expert
- domain/src/main/res/values/strings.xml: achievement_category_expert
- domain/src/main/res/values/strings.xml: achievement_category_organizer
