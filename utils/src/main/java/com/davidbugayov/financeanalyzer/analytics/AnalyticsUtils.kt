...
object AnalyticsUtils {
     ...
     * Логирует событие
     */
    fun logEvent(eventName: String, parameters: android.os.Bundle) {
        val params = parameters.keySet().associateWith { key ->
            parameters.get(key)
    ...
    fun logAchievementUnlocked(
        ...
        tracker.logAchievementUnlocked(achievementId, achievementTitle, achievementCategory, achievementRarity, rewardCoins)
    }
