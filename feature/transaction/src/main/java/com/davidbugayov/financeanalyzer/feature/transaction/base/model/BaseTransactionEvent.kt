...
sealed class BaseTransactionEvent {
    ...
    data class SetCustomCategory(
        val category: String,
    ) : BaseTransactionEvent()

    data class AddCustomCategory(
        val category: String,
    ) : BaseTransactionEvent()
    ...
    data class SetCustomSource(
        val source: String,
    ) : BaseTransactionEvent()

    data class AddCustomSource(
        val source: String,
        val color: Int,
    ) : BaseTransactionEvent()

    data class SetSourceColor(
        val color: Int,
    ) : BaseTransactionEvent()
    ...
    data class SetExpenseCategory(
        val category: String,
    ) : BaseTransactionEvent()

    data class SetIncomeCategory(
        val category: String,
    ) : BaseTransactionEvent()

    data class SetCustomCategoryIcon(
        val icon: ImageVector,
    ) : BaseTransactionEvent()

    data class SetAmountError(
        val isError: Boolean,
    ) : BaseTransactionEvent()
    ...
    data class SetCustomSubcategory(
        val subcategory: String,
    ) : BaseTransactionEvent()

    data class AddCustomSubcategory(
        val subcategory: String,
    ) : BaseTransactionEvent()
