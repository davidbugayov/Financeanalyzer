...
object StringProvider {
    ...
    fun logCsvDelimiterUsed(
        bankName: String,
        delimiter: String,
        columns: Int,
    ): String =
        getString(
            R.string.log_csv_delimiter_used,
            bankName,
            delimiter,
            columns,
        )

    fun logCsvDateNotFound(
        bankName: String,
        columnIndex: Int,
        dateString: String,
    ): String =
        getString(
            R.string.log_csv_date_not_found,
            bankName,
            columnIndex,
            dateString,
        )
    ...
    fun logCsvDateFound(
        ...
        getString(
            R.string.log_csv_date_found,
            bankName,
            columnIndex,
            dateString,
        )

    fun logCsvAmountProcessed(
        bankName: String,
        amountString: String,
        currencyString: String,
    ): String =
        getString(
            R.string.log_csv_amount_processed,
            bankName,
            amountString,
            currencyString,
        )

    fun logCsvDateParsed(
        bankName: String,
        dateString: String,
        format: String,
    ): String =
        getString(
            R.string.log_csv_date_parsed,
            bankName,
            dateString,
            format,
        )
    ...
    fun logNotSavingWallets(
        isExpense: Boolean,
        addToWallet: Boolean,
        selectedWallets: Int,
    ): String =
        getString(
            R.string.log_not_saving_wallets,
            isExpense,
            addToWallet,
            selectedWallets,
        )
    ...
    fun logSelectWalletEvent(
        walletId: String,
        selected: Boolean,
    ): String =
        getString(
            R.string.log_select_wallet_event,
            walletId,
            selected,
        )

    fun logUpdatingSelectedWallets(
        was: Int,
        became: Int,
    ): String =
        getString(
            R.string.log_updating_selected_wallets,
            was,
            became,
        )

    fun logTransactionTypeSwitch(
        from: Boolean,
        to: Boolean,
    ): String =
        getString(
            R.string.log_transaction_type_switch,
            from,
            to,
        )

    fun logTransactionAfterSwitch(
        isExpense: Boolean,
        category: String,
    ): String =
        getString(
            R.string.log_transaction_after_switch,
            isExpense,
            category,
        )
    ...
    fun logExpenseCategoriesSorted(categories: String): String =
        getString(
            R.string.log_expense_categories_sorted,
            categories,
        )

    fun logIncomeCategoriesSorted(categories: String): String =
        getString(
            R.string.log_income_categories_sorted,
            categories,
        )
    ...
    fun logParseMoneyExpression(
        original: String,
        processed: String,
    ): String =
        getString(
            R.string.log_parse_money_expression,
            original,
            processed,
        )

    fun logParseMoneyRemoveOperator(expression: String): String =
        getString(
            R.string.log_parse_money_remove_operator,
            expression,
        )
    ...
    fun logParseMoneyNumberError(expression: String): String =
        getString(
            R.string.log_parse_money_number_error,
            expression,
        )

    fun logParseMoneyInvalidChars(cleaned: String): String = getString(R.string.log_parse_money_invalid_chars, cleaned)

    fun logParseMoneyExpressionSuccess(result: String): String =
        getString(
            R.string.log_parse_money_expression_success,
            result,
        )

    fun logParseMoneyExpressionError(expression: String): String =
        getString(
            R.string.log_parse_money_expression_error,
            expression,
        )

    fun logParseMoneyUnrecognized(expression: String): String =
        getString(
            R.string.log_parse_money_unrecognized,
            expression,
        )

    val logSourcePositionsUpdated: String get() = getString(R.string.log_source_positions_updated)

    fun logCategoryExpenseUsageIncreased(category: String): String =
        getString(
            R.string.log_category_expense_usage_increased,
            category,
        )

    fun logCategoryIncomeUsageIncreased(category: String): String =
        getString(
            R.string.log_category_income_usage_increased,
            category,
        )

    fun logCategoryUsageCount(
        category: String,
        count: Int,
    ): String =
        getString(
            R.string.log_category_usage_count,
            category,
            count,
        )
    ...
    fun logSourceUsageCount(
        source: String,
        count: Int,
    ): String =
        getString(
            R.string.log_source_usage_count,
            source,
            count,
        )
    ...
    fun logSberbankReadError(
        bankName: String,
        message: String,
    ): String =
        getString(
            R.string.log_sberbank_read_error,
            bankName,
            message,
        )
