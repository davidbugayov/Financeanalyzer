...
interface Task<TResult> {
    ...
    fun addOnSuccessListener(p0: Any, p1: OnSuccessListener<in TResult>): Task<TResult>
    fun addOnSuccessListener(p0: Executor, p1: OnSuccessListener<in TResult>): Task<TResult>
    fun addOnFailureListener(p0: OnFailureListener): Task<TResult>
    fun addOnFailureListener(p0: Any, p1: OnFailureListener): Task<TResult>
    fun addOnFailureListener(p0: Executor, p1: OnFailureListener): Task<TResult>
