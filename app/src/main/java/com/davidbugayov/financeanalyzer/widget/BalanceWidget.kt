        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                withContext(Dispatchers.Main) {
                    ...
                    views.setTextColor(R.id.widget_income, context.getColor(com.davidbugayov.financeanalyzer.ui.R.color.income))
                    ...
                    views.setTextColor(R.id.widget_expense, context.getColor(com.davidbugayov.financeanalyzer.ui.R.color.expense))
                    
                    appWidgetManager.updateAppWidget(appWidgetId, views)
                }
                
                Timber.d("Большой виджет обновлен: баланс=${WidgetAmountFormatter.formatForWidget(balance, 10)}, доходы=${WidgetAmountFormatter.formatForWidget(income, 8)}, расходы=${WidgetAmountFormatter.formatForWidget(expense, 8)}")
            } catch (e: Exception) {
