...
object TransactionCategoryDetector {
    ...
    private val rules = mapOf(
        "Переводы" to listOf("внешний перевод", "внутренний перевод", "сбп", "перевод", "перевод сбп"),
        "Пополнения" to listOf("пополнение", "перевод от", "зачисление", "возврат", "внесение наличных"),
        "Продукты" to listOf(
            "пятёрочка",
            "pyaterochka",
            "магнит",
        ...
        "Автомобиль" to listOf("азс", "топливо", "бензин", "автозаправ", "парковк", "стоянк", "автоуслуги", "автосервис"),
        ...
        "Связь" to listOf("связь", "мобильный", "мтс", "билайн", "мегафон", "tele2", "мобильная связь"),
        ...
        "Банковские услуги" to listOf("комиссия", "обслуживание", "процент", "interest", "банковские услуги"),
        "Супермаркеты" to listOf("пятёрочка", "pyaterochka", "магнит", "magnit", "лента", "ашан", "вкусвилл"),
