...
import com.davidbugayov.financeanalyzer.domain.usecase.importtransactions.csv.CsvParseConfig
import com.davidbugayov.financeanalyzer.domain.usecase.importtransactions.csv.GenericCsvImportUseCase
...
class GenericCsvHandler(
    ...
    override fun createImporter(fileType: FileType): ImportTransactionsUseCase {
        if (supportsFileType(fileType)) {
            ...
            Timber.d("[$bankName Handler] Creating GenericCsvImportUseCase with default config: $defaultConfig")
